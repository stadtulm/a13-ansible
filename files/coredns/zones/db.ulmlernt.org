...
@	3600 IN	SOA ns.ulmlernt.org. noc.ulmlernt.de. (
				2021050201 ; serial ;;; PLEASE UPDATE THIS AFTER EACH EDIT!
				1800       ; refresh (30 min)
				1800       ; retry (30 min)
				86400      ; expire (1 day)
				3600       ; minimum (1 hour)
...
fsn30	3600	IN	A	188.34.190.62

fsn31	3600	IN	A	188.34.190.65

fsn32	3600	IN	A	188.34.190.61

fsn33	3600	IN	A	188.34.190.63

fsn34	3600	IN	A	138.201.118.3
fsn34	3600	IN	AAAA	2a01:4f8:c17:f692::2

fsn35	3600	IN	A	116.203.255.134
fsn35	3600	IN	AAAA	2a01:4f8:c17:edcf::2
...
turn02		3600	IN	CNAME	fsn35.ulmlernt.org.
...
turnipv4only02	3600	IN	CNAME	fsn30.ulmlernt.org.
turnipv4only03	3600	IN	CNAME	fsn31.ulmlernt.org.
turnipv4only04	3600	IN	CNAME	fsn32.ulmlernt.org.
turnipv4only05	3600	IN	CNAME	fsn33.ulmlernt.org.
turntest01		3600	IN	CNAME	fsn21.ulmlernt.org.
turntest02		3600	IN	CNAME	fsn28.ulmlernt.org.
